...
const DigitalFurnitureTable: React.FC = () => {
    ...
    const fetchData = async () => {
       setLoading(true)
        await axios.get(`${Url}/api/property/?size=${pagination.pageSize}&page=${pagination.current}&fields=code,movement_status,category,factorCode,inventory,name,property_number,document_code,case,hdd,model,power,phone_feature,ram,install_location,motherboard,cpu,sub_item_type&${qs.stringify(filteredInfo, {
                encode: false,
                arrayFormat: 'comma'
