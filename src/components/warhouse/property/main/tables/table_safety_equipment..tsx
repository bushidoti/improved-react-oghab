...
import SafetyEquipmentTableTablePrint from "../ptrint_table/table_print_safety_equipment";
...
const SafetyEquipmentTable: React.FC = () => {
    ...
    return (
        <>
            ...
            />
            <SafetyEquipmentTableTablePrint componentPDF={componentPDF} property={property !== undefined ? property?.results : []}/>
        </>
    )
};
